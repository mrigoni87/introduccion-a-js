...
let comidasFavoritas = ['asado', 'milanesas', 'tortilla','arroz','vino'];
...
let tercerElementoArray = comidasFavoritas[2];
...
comidasFavoritas[0]='cualquiercosa';
...
comidasFavoritas.push('gelatina');
...
const arrayConst = ['hola1','hola2','hola3',4];
console.log(arrayConst);
arrayConst[1]='hola5';
console.log(arrayConst);
//arrayConst=['hola44','hola23'];
